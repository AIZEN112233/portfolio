...
const Css = () => {
    ...
    return (
        <div
            ...
            className='relative w-fit rounded-xl border-4 border-[#264de4] p-2 after:absolute after:left-1/2 after:top-1/2 after:-z-50 after:h-0 after:w-0 after:rounded-[100px] after:bg-[#264de4] after:duration-500 after:content-[""] hover:after:inset-0 hover:after:h-full hover:after:w-full hover:after:rounded-md'
        >
            <svg
                height='50'
                width='50'
