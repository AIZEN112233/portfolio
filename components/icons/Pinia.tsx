...
const Pinia = () => {
    ...
    return (
        <div
            ...
            className='relative w-fit rounded-xl border-4 border-[#ffc63a] p-2 after:absolute after:left-1/2 after:top-1/2 after:-z-50 after:h-0 after:w-0 after:rounded-[100px] after:bg-[#ffc63a] after:duration-500 after:content-[""] hover:after:inset-0 hover:after:h-full hover:after:w-full hover:after:rounded-md'
        >
            <svg
            ...
            >
                ...
                >
                    ...
                    <g strokeLinecap='round' strokeWidth='11'>
                        ...
                        <g
                            stroke={!isHovered ? "#ffc73b" : "#fff"}
                            transform='matrix(0 1 -1 0 215 207)'
                            className='duration-500'
                        >
                            <path d='m.5.5 49 49' />
                            <path
