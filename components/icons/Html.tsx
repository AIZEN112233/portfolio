...
const Html = () => {
    ...
    return (
        <div className='relative w-fit rounded-xl border-4 border-[#e44f26] p-2 drop-shadow-[0_0px_30px_#e44f26] after:absolute after:left-1/2 after:top-1/2 after:-z-50 after:h-0 after:w-0 after:rounded-[1000px] after:bg-[#e44f26] after:duration-500 after:content-[""] hover:after:inset-0 hover:after:h-full hover:after:w-full hover:after:rounded-md'>
            <svg
